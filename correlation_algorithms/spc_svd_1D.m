function [TY, TX] = spc_svd_1D(REGION_01, REGION_02, SPC_WEIGHTS_ROWS, SPC_WEIGHTS_COLS);
...
[phase_angle_unwrapped_rows, phase_angle_unwrapped_cols] ...
...
TY = -fit_coeff_rows(1) * region_height / (2 * pi);
TX =  fit_coeff_cols(1) * region_width  / (2 * pi);

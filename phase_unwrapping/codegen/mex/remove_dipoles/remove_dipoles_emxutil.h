/*
 * remove_dipoles_emxutil.h
 *
 * Code generation for function 'remove_dipoles_emxutil'
 *
 */

#ifndef __REMOVE_DIPOLES_EMXUTIL_H__
#define __REMOVE_DIPOLES_EMXUTIL_H__
...
/* End of code generation (remove_dipoles_emxutil.h) */
